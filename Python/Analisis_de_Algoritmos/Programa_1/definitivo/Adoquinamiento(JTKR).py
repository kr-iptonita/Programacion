...
try:
    entrada = int(input("Ingresa un valor entero: "))
except ValueError:
    print("La entrada no es un valor entero el programa terminará")
    exit()
else:
    print("La entrada es un valor entero.")
    pass

tamano_cuadricula = 2**entrada
